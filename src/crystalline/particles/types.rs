...
pub struct Emitter {
    ...
    pub rotation: f32,
    /// Render layer for draw ordering. Lower values draw first (behind).
    /// Default 0. Particles from this emitter are interleaved with game
    /// objects based on this value.
    pub render_layer: i32,
}
